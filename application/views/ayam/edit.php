...
<body>
    ...
    <div class="form-container">
        <div class="form-card">
            ...
            <div class="form-header">
                <h2>Edit Data Ayam</h2>
                <p>Perbarui data ayam yang sudah ada di sistem BabeFarm</p>
            </div>
            ...
            <form action="<?= base_url('ayam/update/' . $ayam->id_kandang) ?>" method="post" id="formEditAyam">                 
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                           <input type="date" 
                                name="tanggal_masuk"
                                class="form-control"
                                value="<?= $ayam->tanggal_masuk ?? date('Y-m-d') ?>"
                                max="<?= date('Y-m-d') ?>"
                                required>
                        </div>
                ...
                <div class="form-helper">
                    ...
                    <p>
                        • Pastikan data yang diperbarui sesuai dengan kondisi ayam yang sebenarnya.<br>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Form validation
            const form = document.getElementById('formEditAyam');
            ...
            // Set maximum date to today for tanggal_masuk
            ...
            if (tanggalMasukInput && !tanggalMasukInput.value) {
                tanggalMasukInput.setAttribute('max', localDate);
            }
        });
